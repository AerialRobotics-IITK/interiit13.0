...
#else
  #define CASADI_PREFIX(ID) unbroken_expl_vde_adj_ ## ID
#endif
...
/* unbroken_expl_vde_adj:(i0[13],i1[13],i2[4],i3[17])->(o0[17x1,14nz]) */
...
CASADI_SYMBOL_EXPORT int unbroken_expl_vde_adj(const casadi_real** arg, casadi_real** res, casadi_int* iw, casadi_real* w, int mem){
  return casadi_f0(arg, res, iw, w, mem);
}

CASADI_SYMBOL_EXPORT int unbroken_expl_vde_adj_alloc_mem(void) {
  return 0;
}

CASADI_SYMBOL_EXPORT int unbroken_expl_vde_adj_init_mem(int mem) {
  return 0;
}

CASADI_SYMBOL_EXPORT void unbroken_expl_vde_adj_free_mem(int mem) {
}

CASADI_SYMBOL_EXPORT int unbroken_expl_vde_adj_checkout(void) {
  return 0;
}

CASADI_SYMBOL_EXPORT void unbroken_expl_vde_adj_release(int mem) {
}

CASADI_SYMBOL_EXPORT void unbroken_expl_vde_adj_incref(void) {
}

CASADI_SYMBOL_EXPORT void unbroken_expl_vde_adj_decref(void) {
}

CASADI_SYMBOL_EXPORT casadi_int unbroken_expl_vde_adj_n_in(void) { return 4;}

CASADI_SYMBOL_EXPORT casadi_int unbroken_expl_vde_adj_n_out(void) { return 1;}

CASADI_SYMBOL_EXPORT casadi_real unbroken_expl_vde_adj_default_in(casadi_int i) {
  switch (i) {
    default: return 0;
  }
}

CASADI_SYMBOL_EXPORT const char* unbroken_expl_vde_adj_name_in(casadi_int i) {
  switch (i) {
    case 0: return "i0";
    case 1: return "i1";
    case 2: return "i2";
...
CASADI_SYMBOL_EXPORT const char* unbroken_expl_vde_adj_name_out(casadi_int i) {
  switch (i) {
    case 0: return "o0";
    default: return 0;
  }
...
CASADI_SYMBOL_EXPORT const casadi_int* unbroken_expl_vde_adj_sparsity_in(casadi_int i) {
  switch (i) {
...
CASADI_SYMBOL_EXPORT const casadi_int* unbroken_expl_vde_adj_sparsity_out(casadi_int i) {
  switch (i) {
...
CASADI_SYMBOL_EXPORT int unbroken_expl_vde_adj_work(casadi_int *sz_arg, casadi_int* sz_res, casadi_int *sz_iw, casadi_int *sz_w) {
  if (sz_arg) *sz_arg = 8;
  if (sz_res) *sz_res = 7;
  if (sz_iw) *sz_iw = 0;
  if (sz_w) *sz_w = 135;
...
CASADI_SYMBOL_EXPORT int unbroken_expl_vde_adj_work_bytes(casadi_int *sz_arg, casadi_int* sz_res, casadi_int *sz_iw, casadi_int *sz_w) {
