...
class Quadrotor3D:
    def __init__(self, drag=False, motor_noise=False):
        ...
        self.max_thrust = 8.54858  # maximum thrust
        self.J = np.array([0.02361518496, 0.02371810977, 0.04218956356])  # moment of inertia of quadrotor
        self.mass = 2.064  # Mass of Quadrotor
        self.length = 0.2460  # half of the full arm length
